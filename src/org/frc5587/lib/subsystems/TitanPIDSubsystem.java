 ...
 */
public abstract class TitanPIDSubsystem extends SubsystemBase {
   ...
   */
  public TitanPIDSubsystem(ProfiledPIDController controller, double initialPosition) {
    m_controller = requireNonNullParam(controller, "controller", "ProfiledPIDSubsystem");
    setGoal(initialPosition);
  }

  /**
   * Creates a new PIDSubsystem. Initial goal position is zero.
   *
   * @param controller the ProfiledPIDController to use
   */
  public TitanPIDSubsystem(ProfiledPIDController controller) {
    this(controller, 0);
  }
