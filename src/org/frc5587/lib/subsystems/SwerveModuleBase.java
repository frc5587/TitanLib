...
public abstract class SwerveModuleBase {
    ...
    public void resetToAbsolute() {
        setAngleMotorEncoderPosition(Conversions.motorOutputToMechanismOutput(getAbsoluteEncoderValue().minus(angleOffset), moduleConstants.angleMotorEncoderCPR, moduleConstants.angleMotorGearRatio));
    }
